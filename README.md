...
This boilerplate implements some basic features such as: `Typescript`, `Styled-Components`, `Jest`, `React Testing Library`, `ESLint`, `Prettier`, `Storybook` and some other stuff.
